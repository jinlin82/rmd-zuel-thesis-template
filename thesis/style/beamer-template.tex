\documentclass[$if(fontsize)$$fontsize$,$endif$$if(lang)$$babel-lang$,$endif$$if(handout)$handout,$endif$$if(beamer)$ignorenonframetext,11pt,xcolor=dvipsnames,table,hyperref={colorlinks,allcolors=.,urlcolor=blue, citecolor=violet, bookmarksdepth=4},$endif$$for(classoption)$$classoption$$sep$,$endfor$]{$documentclass$}
...
\usepackage{ragged2e}                      % 提供 \justifying 命令
...
\usepackage{listings}
\newcommand{\passthrough}[1]{\setlength{\fboxsep}{0pt}\colorbox{Periwinkle!20}{\strut{#1}}}
\usepackage{tikz}
...
\setbeamerfont{item projected}{family=\fontspec{Microsoft YaHei}}
\setbeamercolor{item projected}{bg=RoyalPurple, fg=White}
\setbeamerfont{section number projected}{family=\fontspec{Microsoft YaHei}}
\setbeamercolor{section number projected}{bg=RoyalPurple, fg=White}
...
% \everydisplay{\color{blue}} % 和 align 环境冲突， 改用下面语句
...
\usepackage[skip=0pt, labelsep=quad, labelfont={color={Violet}}]{caption}
